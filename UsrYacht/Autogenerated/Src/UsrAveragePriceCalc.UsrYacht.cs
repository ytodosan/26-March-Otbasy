namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrAveragePriceCalcMethodsWrapper

	/// <exclude/>
	public class UsrAveragePriceCalcMethodsWrapper : ProcessModel
	{

		public UsrAveragePriceCalcMethodsWrapper(Process process)
			: base(process) {
